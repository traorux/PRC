...
namespace PRC.CORE.Media.Call
{
    ...
    {
        //public event Action<O2GEventArgs<OnCallCreatedEvent>> CallCreated;
        //public event Action<O2GEventArgs<OnCallModifiedEvent>> CallModified;
        //public event Action<O2GEventArgs<OnCallRemovedEvent>> CallRemoved;
        //public event Action<O2GEventArgs<OnUserStateModifiedEvent>> UserStateModified;
        //public event Action<O2GEventArgs<OnTelephonyStateEvent>> TelephonyState;
        //public event Action<O2GEventArgs<OnDeviceStateModifiedEvent>> DeviceStateModified;
        //public event Action<O2GEventArgs<OnDynamicStateChangedEvent>> DynamicStateChanged;
        ...
        //Task<List<PbxCall>> GetCallsAsync(string loginName = null); //PbxCall
